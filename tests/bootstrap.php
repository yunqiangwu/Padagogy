 ...
 * @since 0.0.0
 */
function _manually_load_padagogy_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/padagogy.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_padagogy_plugin' );
